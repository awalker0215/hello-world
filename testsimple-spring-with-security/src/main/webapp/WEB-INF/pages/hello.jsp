...
<body>
	...
	<sec:authorize access="hasRole('ROLE_ADMIN')">
		<!-- For login user -->
	<form id="form1" name="form1" method="post" action="/simple-spring-with-security/delete" action2="/simple-spring-with-security/delete2">
		...
		<table width="500" border="0" cellspacing="0" cellpadding="0">
		  <tr>
		    ...
		    <td width="250" align="center"><input type="submit" name="button4" id="button4" value="hello2" OnClick="change_action4();"></td>		    
		  </tr>
		</table>
